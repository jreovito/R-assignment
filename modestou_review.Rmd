...
4. You still need two additional graphs for the Visualization Part of the assignment: one for the Missing data and Amount of Heterozygosity and another entirely of your choice. You only have the first one so far, i.e., SNPs per chromosome. Please remember to include those in your final submission.

5. Good job despite the technical difficulties! I wish I could run your code on my desktop to offer more insightful suggestions.